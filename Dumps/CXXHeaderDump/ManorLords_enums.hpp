enum class EActionType {
    ...
    QueuedPickup = 62,
    UnequipCart = 63,
    ConstructionDigFlatten = 64,
    ClimbLadderUp = 65,
    ClimbLadderDown = 66,
    WaitForCartLoading = 67,
    LoadOtherUnit = 68,
    EActionType_MAX = 69,
};
...
enum class EBuildingPrimitiveData {
    ...
    WallNormalRightX = 18,
    WallNormalRightY = 19,
    MarketTextureTopLeft = 20,
    MarketTextureTopRight = 21,
    MarketTextureBottomRight = 21,
    MarketTextureBottomLeft = 22,
    EBuildingPrimitiveData_MAX = 23,
};
...
enum class EBuildingType {
    ...
    SiegeCamp = 483,
    BurgagePlot_Lv4 = 484,
    EBuildingType_MAX = 485,
};

enum class ECameraDistance {
    Invalid = 0,
    SuperClose = 1,
    Close = 2,
    Mid = 3,
    Far = 4,
    ECameraDistance_MAX = 5,
};
...
enum class EGroundCollisionState {
    Invalid = 0,
    Enabled = 1,
    Disabled = 2,
    EGroundCollisionState_MAX = 3,
};
...
enum class EInventoryTabCategory {
    Residential = 0,
    General = 1,
    Construction = 2,
    Taxes = 3,
...
enum class EItemType {
    ...
    CONSUM_mead = 353,
    CONSUM_cider = 354,
    Recipe_Sausage_Beef = 355,
    Recipe_Sausage_Pork = 356,
    EItemType_MAX = 357,
};
...
enum class ELastSquadTargetType {
    Invalid = 0,
    Point = 1,
    Building = 2,
    ResourceNode = 3,
    ELastSquadTargetType_MAX = 4,
};
...
enum class ELordGender {
    Male = 0,
    Female = 1,
    ELordGender_MAX = 2,
};

enum class EMLTextState {
    Default = 0,
    Hovered = 1,
    Pressed = 2,
    Selected = 3,
...
enum class EMaintenanceEffect {
    NoEffect = 0,
    InfluenceGain = 1,
    InfluenceLoss = 2,
    LaborSpeedIncrease = 3,
    LaborSpeedDecrease = 4,
    LaborSpeedDecreaseAndBotching = 5,
    InjuryChance = 6,
    CollapseChance = 7,
    Botching = 8,
    MAX = 9,
...
enum class EPathFailReason {
    ...
    NoSourceOrTargetConnections = 3,
    NodeLimitReached = 4,
    AllConnectionsChecked = 5,
    InvalidTarget = 6,
    InvalidSource = 7,
    EPathFailReason_MAX = 8,
};
...
enum class EPerkEffect {
    ...
    ReduceMineUpkeep = 26,
    LebkuchenProduction = 27,
    CiderProduction = 28,
    AdditionalPollinationBonus = 29,
    TradeRoutesImprovesApproval = 30,
    GainInfluenceFromTrading = 31,
    IncreaseImmigrationRate = 32,
    ForagingHutSupportsExtraFamilies = 33,
    PasturesGainAnElevationBonus = 34,
    InterestOnRegionalWealth = 35,
    GainInfluenceFromRegionalWealth = 36,
    ExtraApprovalFromFoodVariety = 37,
    BurgagePlotProduceMoreRegionalWealthWhenApprovalIsHigh = 38,
    ProficiencyApprovalBuff = 39,
    RuralBuildingProficiencyBuff = 40,
    EfficiencyFromCraftsmanNetwork = 41,
    BuildingsNearRiverGainRegionWealth = 42,
    RegionalWealthGainedFromChurch = 43,
    CraftmenWithFilledAdditionalLivingSpaceOperateWithExtraProficiency = 44,
    TenPercentTaxIncrease = 45,
    TenPercentRegionWealthDecrease = 46,
    CraftmenDoNotRequireAnyChurchLevel = 47,
    UnlockKennelsAndDogs = 48,
    ProficiencyBonusForWeaponCraftsmen = 49,
    DecreasedApproval = 50,
    RawResourcesPriceDeducation = 51,
    TaxGenerationReduction = 52,
    ForestersPlantTreesAllYearRound = 53,
    Smallholdings = 54,
    ForagedGoodsCapacityBoost = 55,
    TitheApprovalPenalty = 56,
    FarmingYieldPenalty = 57,
    SkilledWoodworkers = 58,
    ForestCombatBuff = 59,
    MiningCraftingSpeedMalus = 60,
    MilitiaImprovedMaintenance = 61,
    IncreasedPassiveIncome = 62,
    CheaperBurgageUpgrades = 63,
    SaltAndIronImportDiscount = 64,
    TaxApprovalGeneralPenalty = 65,
    BlacksmithYieldIncrease = 66,
    WeaponExportValueIncrease = 67,
    MilitiaEquipmentApprovalGain = 68,
    LocalHandymenAffinityBonus = 69,
    LivestockYieldPenalty = 70,
    ReducedClothingConsumption = 71,
    ResilientSheep = 72,
    PlentifulWildlife = 73,
    IncreasedHunterYield = 74,
    TradeRouteCostPenalty = 75,
    ImprovedStonemasonsStation = 76,
    CastleCostReduction = 77,
    HuntingAndFishingProductivityPenalty = 78,
    OxHandlerSpeedBuff = 79,
    ArmorerArtisanBuff = 80,
    ImprovedMineMaintenance = 81,
    MiningTradeDiscounts = 82,
    RetinueHireCostPenalty = 83,
    EfficientElevationFarming = 84,
    LivestockImportDiscounts = 85,
    MiningSpeedIncrease = 86,
    ArtisanEfficiencyPenalty = 87,
    ImprovedStoneGathering = 88,
    MeadProduction = 89,
    BackyardAnimalBuff = 90,
    FieldFertilityClamp = 91,
    ApiaryPollinationBuff = 92,
    DroughtResistance = 93,
    ReducedCropSpoilage = 94,
    IncreasedCropExportValue = 95,
    EPerkEffect_MAX = 96,
};

enum class EPerkSlot {
    None = 0,
    Origins = 1,
    TradePriviliges = 2,
    RuralFounations = 3,
...
enum class EProblem {
    ...
    Unmaintained = 50,
    NoConstructionYardBuilders = 51,
    AnimalHunger = 52,
    NoActiveRecipe = 53,
    ConstructionSiteOutsideWorkArea = 54,
    COUNT = 55,
    EProblem_MAX = 56,
};
...
enum class EProductivityModifier {
    ...
    CraftingSpeed_Perk_ImprovedStoneGathering = 5,
    WalkingSpeed_Perk_OxHandlerSpeedBuff = 6,
    CraftingSpeed_Maintenance_Failed = 7,
    CraftingSpeed_Maintenance_Half = 8,
    CraftingSpeed_Maintenance_Double = 9,
    EProductivityModifier_MAX = 10,
};
...
enum class EQueuedUIUpdateType {
    RegionalStock = 0,
    RegionalSurplus = 1,
    EQueuedUIUpdateType_MAX = 2,
};
...
enum class EYieldModifier {
    ...
    Perk_BackyardAnimalBuff = 11,
    Policy_HuntingGrounds = 12,
    Affinity_Pollination = 13,
    Affinity_Pannage = 14,
    Affinity_BarkGathering = 15,
    EYieldModifier_MAX = 16,
};
