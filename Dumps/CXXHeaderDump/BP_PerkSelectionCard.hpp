...
class UBP_PerkSelectionCard_C : public URegionDevelopmentPerkEntry
{
    ...
    class UImage* perkSelectedFrame;                                                  // 0x0308 (size: 0x8)
    class UImage* perkTexture;                                                        // 0x0310 (size: 0x8)
    class UButton* selectionButton;                                                   // 0x0318 (size: 0x8)
    class UImage* SelectionFrame_IMG;                                                 // 0x0320 (size: 0x8)
    class UBP_PerkSelectionPanel_C* owningPanel;                                      // 0x0328 (size: 0x8)
    class UDataTable* DT_Tech;                                                        // 0x0330 (size: 0x8)
    bool isPerkActivated;                                                             // 0x0338 (size: 0x1)
    ...
    void UpdateActivatedPerkCard(bool AreAnyPerksActive);
