...
class UPlusMinus_C : public UNaviSubGrid
{
    ...
    class UButton* Button_0;                                                          // 0x0370 (size: 0x8)
    class UButton* Button_1;                                                          // 0x0378 (size: 0x8)
    class UImage* Image_221;                                                          // 0x0380 (size: 0x8)
    class UImage* Image_308;                                                          // 0x0388 (size: 0x8)
    class UMD_NaviAutoButton_C* navi_BtnDown;                                         // 0x0390 (size: 0x8)
    class UMD_NaviAutoButton_C* navi_BtnUp;                                           // 0x0398 (size: 0x8)
    class UTextBlock* priorityNum_txt;                                                // 0x03A0 (size: 0x8)
    int32 Var;                                                                        // 0x03A8 (size: 0x4)
    class UInventory_C* inventoryRef;                                                 // 0x03B0 (size: 0x8)
    FPlusMinus_CPriorityChanged priorityChanged;                                      // 0x03B8 (size: 0x10)
