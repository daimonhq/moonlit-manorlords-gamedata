...
class UquestMessageElaborate_C : public UUserWidget
{
    ...
    FQuest Quest;                                                                     // 0x0398 (size: 0x120)
    bool Pressed;                                                                     // 0x04B8 (size: 0x1)
    FLetter Letter;                                                                   // 0x04C0 (size: 0x48)
    FquestMessageElaborate_CLetterOpened LetterOpened;                                // 0x0508 (size: 0x10)
    void LetterOpened(FGuid LetterUniqueId);
    ...
    void LetterOpened__DelegateSignature(FGuid LetterUniqueId);
}; // Size: 0x518
