...
class UMD_NaviHijackProxy_C : public UNaviUi
{
    ...
    FMD_NaviHijackProxy_CHijackedHandleInput HijackedHandleInput;                     // 0x0370 (size: 0x10)
    void HijackedHandleInput(ENaviUiIntent intent);
    bool DoesWantAllInput;                                                            // 0x0380 (size: 0x1)
    ENaviUiHighlightStyle Style;                                                      // 0x0381 (size: 0x1)
