...
class UbellSelectorWidget_C : public UNaviSubGrid
{
    ...
    class UImage* Image_46;                                                           // 0x0380 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox;                                      // 0x0388 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton;                                    // 0x0390 (size: 0x8)
    class UMD_NaviAutoButton_C* Navi_BtnNext;                                         // 0x0398 (size: 0x8)
    class UMD_NaviAutoButton_C* Navi_BtnPrev;                                         // 0x03A0 (size: 0x8)
    class UButton* nextBell;                                                          // 0x03A8 (size: 0x8)
    class UButton* playBell;                                                          // 0x03B0 (size: 0x8)
    class UButton* prevBell;                                                          // 0x03B8 (size: 0x8)
