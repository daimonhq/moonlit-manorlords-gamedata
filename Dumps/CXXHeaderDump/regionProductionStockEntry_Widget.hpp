...
class UregionProductionStockEntry_Widget_C : public URegionProductionStockEntry
{
    ...
    class URichTextBlock* ProducedText;                                               // 0x0350 (size: 0x8)
    class UDataTable* ItemsDT;                                                        // 0x0358 (size: 0x8)
    bool IsTracked;                                                                   // 0x0360 (size: 0x1)
    class UCustomTooltip_C* ToolTip;                                                  // 0x0368 (size: 0x8)
