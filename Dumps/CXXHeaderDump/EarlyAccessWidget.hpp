...
class UEarlyAccessWidget_C : public UNaviUi
{
    ...
    class UWidgetAnimation* lerpIn;                                                   // 0x0368 (size: 0x8)
    class UButton* Button;                                                            // 0x0370 (size: 0x8)
    class UTextBlock* Header;                                                         // 0x0378 (size: 0x8)
    class UImage* Image;                                                              // 0x0380 (size: 0x8)
    class UImage* Image_7;                                                            // 0x0388 (size: 0x8)
    class UImage* Image_54;                                                           // 0x0390 (size: 0x8)
    class UMD_ControllerHotkey_C* MD_ControllerHotkey;                                // 0x0398 (size: 0x8)
    class UMD_NaviAutoFocusHighlight_C* MD_NaviAutoFocusHighlight;                    // 0x03A0 (size: 0x8)
    class UTextBlock* nda_txt_1;                                                      // 0x03A8 (size: 0x8)
    FEarlyAccessWidget_COnDone OnDone;                                                // 0x03B0 (size: 0x10)
    void OnDone();
