...
class AMyRTSMultiEngineCPP_BP_C : public ARTSMultiEngineCPP
{
    ...
    class UInstancedStaticMeshComponent* InstanceSnowTrails;                          // 0x15D0 (size: 0x8)
    double buildingCullDistance;                                                      // 0x15D8 (size: 0x8)
    double unitCullDistance;                                                          // 0x15E0 (size: 0x8)
