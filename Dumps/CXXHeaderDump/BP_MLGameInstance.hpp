...
class UBP_MLGameInstance_C : public UMLGameInstance
{
    ...
    TArray<FName> nobleLastNames;                                                     // 0x0698 (size: 0x10)
    EGameDifficulty mainMenu_SelectedDifficulty;                                      // 0x06A8 (size: 0x1)
    bool introMsgShown;                                                               // 0x06A9 (size: 0x1)
    FString CurrentAppliedAaAlgo;                                                     // 0x06B0 (size: 0x10)
    bool DlssUseAuto;                                                                 // 0x06C0 (size: 0x1)
    int32 DlssQualityMode;                                                            // 0x06C4 (size: 0x4)
    bool IsUpscalerCvarHookingEnabled;                                                // 0x06C8 (size: 0x1)
