...
class UstorageFilterCategory_C : public UNaviSubGrid
{
    ...
    class UButton* acceptAllCategory;                                                 // 0x0370 (size: 0x8)
    class UButton* Button_52;                                                         // 0x0378 (size: 0x8)
    class UTextBlock* category_text;                                                  // 0x0380 (size: 0x8)
    class UWrapBox* goodTypes_WB;                                                     // 0x0388 (size: 0x8)
    class UImage* Image_0;                                                            // 0x0390 (size: 0x8)
    class UImage* Image_1;                                                            // 0x0398 (size: 0x8)
    class UMD_NaviAutoButton_C* navi_AcceptAll;                                       // 0x03A0 (size: 0x8)
    class UMD_NaviAutoButton_C* navi_BlockAll;                                        // 0x03A8 (size: 0x8)
    TArray<int32> typesOfGoods;                                                       // 0x03B0 (size: 0x10)
    FName category_name;                                                              // 0x03C0 (size: 0x8)
    EItemCategory Category;                                                           // 0x03C8 (size: 0x1)
    EStorageType storageType;                                                         // 0x03C9 (size: 0x1)
    class ASMBuildingMaster* building;                                                // 0x03D0 (size: 0x8)
    TArray<int32> maretkplaceDistributableNonFoodItems;                               // 0x03D8 (size: 0x10)
    FstorageFilterCategory_COnControllerGridMemberFocused OnControllerGridMemberFocused; // 0x03E8 (size: 0x10)
