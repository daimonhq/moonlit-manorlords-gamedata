...
class ULivestockEntry_C : public UNaviSubGrid
{
    ...
    class UEditableText* EditableName;                                                // 0x0378 (size: 0x8)
    class UHorizontalBox* hb_status;                                                  // 0x0380 (size: 0x8)
    class UImage* Image;                                                              // 0x0388 (size: 0x8)
    class UImage* Image_101;                                                          // 0x0390 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton;                                    // 0x0398 (size: 0x8)
    class UMD_NaviHijackProxy_C* navi_nameEdit;                                       // 0x03A0 (size: 0x8)
    class UTextBlock* task_txt;                                                       // 0x03A8 (size: 0x8)
    class ASMUnit* unit;                                                              // 0x03B0 (size: 0x8)
    FString statusText;                                                               // 0x03B8 (size: 0x10)
    bool shouldUpdateByTimer;                                                         // 0x03C8 (size: 0x1)
    bool widgetSpawnComplete;                                                         // 0x03C9 (size: 0x1)
    EUnitRole currentUnitRole;                                                        // 0x03CA (size: 0x1)
