...
class UCreditsPage_C : public UNaviSubGrid
{
    ...
    class UBorder* Border_128;                                                        // 0x0378 (size: 0x8)
    class UVerticalBox* credits;                                                      // 0x0380 (size: 0x8)
    class UImage* Grunge;                                                             // 0x0388 (size: 0x8)
    class UImage* Image_202;                                                          // 0x0390 (size: 0x8)
    class UImage* logo_img;                                                           // 0x0398 (size: 0x8)
    class UmenuButton_C* return_button;                                               // 0x03A0 (size: 0x8)
    class UmenuButton_C* secret_button;                                               // 0x03A8 (size: 0x8)
    class UVerticalBox* VerticalBox_0;                                                // 0x03B0 (size: 0x8)
    FCreditsPage_COnDone OnDone;                                                      // 0x03B8 (size: 0x10)
    void OnDone();
    double RollTime;                                                                  // 0x03C8 (size: 0x8)
    double EndTime;                                                                   // 0x03D0 (size: 0x8)
    double Time;                                                                      // 0x03D8 (size: 0x8)
    bool InSetup;                                                                     // 0x03E0 (size: 0x1)
    TArray<FCreditsLine> PendingCreditLines;                                          // 0x03E8 (size: 0x10)
    int32 PerFrameCreationCount;                                                      // 0x03F8 (size: 0x4)
    FString CreditsData;                                                              // 0x0400 (size: 0x10)
