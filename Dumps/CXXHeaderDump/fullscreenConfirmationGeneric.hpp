...
class UfullscreenConfirmationGeneric_C : public UNaviSubGrid
{
    ...
    class UmenuButton_C* No;                                                          // 0x0370 (size: 0x8)
    class UTextBlock* TextBlock_0;                                                    // 0x0378 (size: 0x8)
    class UmenuButton_C* Yes;                                                         // 0x0380 (size: 0x8)
    FfullscreenConfirmationGeneric_COnDecision OnDecision;                            // 0x0388 (size: 0x10)
    void OnDecision(bool confirmed);
    FName questionKey;                                                                // 0x0398 (size: 0x8)
