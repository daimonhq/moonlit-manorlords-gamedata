...
class UMLDefaultCheckbox_C : public UNaviUi
{
    ...
    class UCheckBox* CheckmarkControl;                                                // 0x0368 (size: 0x8)
    class UMD_NaviAutoFocusHighlight_C* MD_NaviAutoFocusHighlight;                    // 0x0370 (size: 0x8)
    class UNamedSlot* RightNamedSlot;                                                 // 0x0378 (size: 0x8)
    ECheckBoxState DefaultCheckedState;                                               // 0x0380 (size: 0x1)
    FMLDefaultCheckbox_COnValueChange OnValueChange;                                  // 0x0388 (size: 0x10)
    void OnValueChange(bool IsChecked);
    bool allowTriggeringCallback;                                                     // 0x0398 (size: 0x1)
    int32 SizeOfCheckbox;                                                             // 0x039C (size: 0x4)
    bool InInit;                                                                      // 0x03A0 (size: 0x1)
    bool HasExternalValue;                                                            // 0x03A1 (size: 0x1)
