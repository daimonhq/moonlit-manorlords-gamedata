...
class UBigBuildingTooltip_C : public UUserWidget
{
    ...
    class UImage* Image_67;                                                           // 0x0340 (size: 0x8)
    class UImage* Image_334;                                                          // 0x0348 (size: 0x8)
    class UTextBlock* name_txt;                                                       // 0x0350 (size: 0x8)
    class UHorizontalBox* relocation_hb;                                              // 0x0358 (size: 0x8)
    class UTextBlock* TextBlock;                                                      // 0x0360 (size: 0x8)
    class UTextBlock* TextBlock_53;                                                   // 0x0368 (size: 0x8)
    class UTextBlock* TextBlock_561;                                                  // 0x0370 (size: 0x8)
    class UImage* Thumbnail;                                                          // 0x0378 (size: 0x8)
    ...
    TSoftObjectPtr<UTexture2D> Out Row Panel Image;                                   // 0x03B8 (size: 0x28)

    void UpdateStatusOfRequiredGoods();
    void Construct();
    void Tick(FGeometry MyGeometry, float InDeltaTime);
    void InitToolTip(int32 InBuildingID);
