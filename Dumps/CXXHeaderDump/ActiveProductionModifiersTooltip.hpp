...
class UActiveProductionModifiersTooltip_C : public UUserWidget
{
    ...
    class UlocalizedTextBox_C* ModifiersText;                                         // 0x02F0 (size: 0x8)
    class UHorizontalBox* NoModifiersEntry;                                           // 0x02F8 (size: 0x8)
    class UlocalizedTextBox_C* NoneText;                                              // 0x0300 (size: 0x8)
    class UlocalizedTextBox_C* NoneText_1;                                            // 0x0308 (size: 0x8)
    class UVerticalBox* ProductionModifiersBox;                                       // 0x0310 (size: 0x8)
    class UVerticalBox* ProductionModifiersEntries;                                   // 0x0318 (size: 0x8)
    ...
    void GetModifierData(EProductivityModifier Modifier, FName& PerkName, FName& ModiferEffect);
    void UpdateBuilding(class ASMBuildingMaster* building);
    void UpdateProductionModifiers();
    void Construct();
    void ExecuteUbergraph_ActiveProductionModifiersTooltip(int32 EntryPoint);
}; // Size: 0x328
