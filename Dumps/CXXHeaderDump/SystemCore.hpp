...
struct FMLCoatFieldMask
{
    FVector2D Offset;                                                                 // 0x0000 (size: 0x10)
    FVector2D scale;                                                                  // 0x0010 (size: 0x10)

}; // Size: 0x20

struct FMLCoatFieldMaskContainer
{
    TSoftObjectPtr<UTexture2D> DisplayTexture;                                        // 0x0000 (size: 0x28)
    TArray<FMLCoatFieldMask> Masks;                                                   // 0x0028 (size: 0x10)
...
struct FNaviGridLinkage
{
    class UNaviUi* Source;                                                            // 0x0000 (size: 0x8)
    ENaviUiIntent Direction;                                                          // 0x0008 (size: 0x1)
    class UNaviUi* Destination;                                                       // 0x0010 (size: 0x8)
...
struct FNaviGridState
{
    ...
    TMap<class UNaviUi*, class FNaviGridTeleport> teleports;                          // 0x0110 (size: 0x50)
    TSet<UNaviUi*> teleportSources;                                                   // 0x0160 (size: 0x50)
    TMap<class ENaviUiIntent, class UNaviUi*> temporalTeleports;                      // 0x01B0 (size: 0x50)

}; // Size: 0x200

struct FNaviGridTeleport
{
    TMap<class ENaviUiIntent, class UNaviUi*> links;                                  // 0x0000 (size: 0x50)
...
struct FNaviPrimeGridLayout
{
    ...
    TArray<FNaviGridLinkage> teleports;                                               // 0x00B0 (size: 0x10)
...
struct FNaviSubGridLayout
{
    ...
    TArray<FNaviGridLinkage> teleports;                                               // 0x0108 (size: 0x10)
...
class UAutoIconWidget : public UUserWidget
{
    ...
    void SetupParentNaviui(class UNaviUi* parentNaviWidget);
    void SetIcon(class UTexture2D* iconSource);
}; // Size: 0x2D0

class UCoatOfArmsLibrary : public UObject
{
    TArray<TSoftObjectPtr<UTexture2D>> BackgroundTextures;                            // 0x0028 (size: 0x10)
    TArray<TSoftObjectPtr<UTexture2D>> ForegroundTextures;                            // 0x0038 (size: 0x10)
    TArray<TSoftObjectPtr<UTexture2D>> FieldDivisionTextures;                         // 0x0048 (size: 0x10)
    TArray<TSoftObjectPtr<UTexture2D>> PortraitTextures;                              // 0x0058 (size: 0x10)
    TArray<int32> FemalePortraitIndices;                                              // 0x0068 (size: 0x10)
    TArray<FLinearColor> AvailableColors;                                             // 0x0078 (size: 0x10)
    TMap<class TSoftObjectPtr<UTexture2D>, class FMLCoatFieldMaskContainer> FieldMasks; // 0x0088 (size: 0x50)
    TMap<class TSoftObjectPtr<UTexture2D>, class TSoftObjectPtr<UTexture2D>> CoatSymbolMap; // 0x00D8 (size: 0x50)
    int32 LoadingIndex;                                                               // 0x0128 (size: 0x4)
...
{
    FNaviGridState gridState;                                                         // 0x0360 (size: 0x200)
    FNaviGridConfig gridConfig;                                                       // 0x0560 (size: 0x10)
...
{
    class UNaviGrid* hostGrid;                                                        // 0x0360 (size: 0x8)
...
class UNaviUi : public UUserWidget
{
    ...
    FNaviUiOnShowVisualChangeDelegate OnShowVisualChangeDelegate;                     // 0x02F0 (size: 0x10)
    void OnShowVisualChange(bool doShowVisuals);
    FNaviUiOnHandleInputDelegate OnHandleInputDelegate;                               // 0x0300 (size: 0x10)
    ENaviHandleMethod OnHandleInput(ENaviUiIntent Key);
    class UNaviUi* Parent;                                                            // 0x0310 (size: 0x8)
    TArray<class UNaviUi*> Children;                                                  // 0x0318 (size: 0x10)
    FString internal_id;                                                              // 0x0328 (size: 0x10)
    bool internal_hasFocus;                                                           // 0x0338 (size: 0x1)
    class UNaviUi* internal_priorityChild;                                            // 0x0340 (size: 0x8)
    float timeOfLastMovement;                                                         // 0x0348 (size: 0x4)
    int32 consecutiveMovements;                                                       // 0x034C (size: 0x4)
    class UWidget* shownTooltipWidget;                                                // 0x0350 (size: 0x8)
    class UWidget* shownTooltipParent;                                                // 0x0358 (size: 0x8)

    bool WantsAllInput();
    void StealFocus();
    void SetShowNaviVisuals(bool showNaviVisuals);
    void SetPriorityChild(class UNaviUi* nextPriorityChild);
    void SetParent(class UNaviUi* InParent);
    void SetNaviMode(bool isControllerMode);
...
class UPlatformManager : public UObject
{
    ...
    class UStoveIntegrator* stove;                                                    // 0x0040 (size: 0x8)
...
class UStaticInputConfig : public UBlueprintFunctionLibrary
{
    ...
    FName Axis_MenuAnalog_Rightward();
    FName Axis_MenuAnalog_Forward();
