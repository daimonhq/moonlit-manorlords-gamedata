...
class UiconButton_C : public UNaviUi
{
    ...
    class UImage* IconDisplay;                                                        // 0x0370 (size: 0x8)
    class UMD_NaviAutoFocusHighlight_C* MD_NaviAutoFocusHighlight;                    // 0x0378 (size: 0x8)
    class UBorder* Tinter;                                                            // 0x0380 (size: 0x8)
    FiconButton_COnReleased OnReleased;                                               // 0x0388 (size: 0x10)
    void onReleased();
    class USoundBase* pressedSfx;                                                     // 0x0398 (size: 0x8)
    class UTexture2D* iconTexture;                                                    // 0x03A0 (size: 0x8)
    int32 IconSize;                                                                   // 0x03A8 (size: 0x4)
    bool IsActiveSelection;                                                           // 0x03AC (size: 0x1)
