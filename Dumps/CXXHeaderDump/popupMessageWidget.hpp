...
class UpopupMessageWidget_C : public UNaviSubGrid
{
    ...
    class UWidgetAnimation* fadeInMessage;                                            // 0x0370 (size: 0x8)
    class UWidgetAnimation* fadeInGraphic;                                            // 0x0378 (size: 0x8)
    class UButton* Button_Accept;                                                     // 0x0380 (size: 0x8)
    class UTextBlock* choiceA;                                                        // 0x0388 (size: 0x8)
    class UImage* graphic;                                                            // 0x0390 (size: 0x8)
    class UMD_NaviAutoButton_C* MD_NaviAutoButton;                                    // 0x0398 (size: 0x8)
    class URichTextBlock* messageTxt;                                                 // 0x03A0 (size: 0x8)
    class UImage* Spacer;                                                             // 0x03A8 (size: 0x8)
    class UImage* Spacer_2;                                                           // 0x03B0 (size: 0x8)
    class UTextBlock* Title1_1;                                                       // 0x03B8 (size: 0x8)
    class UTextBlock* title_txt;                                                      // 0x03C0 (size: 0x8)
    class UVerticalBox* title_vb;                                                     // 0x03C8 (size: 0x8)
    FName messageType;                                                                // 0x03D0 (size: 0x8)
    class ARegion* Region;                                                            // 0x03D8 (size: 0x8)
    bool closing;                                                                     // 0x03E0 (size: 0x1)
