...
class UmenuButton_C : public UNaviUi
{
    ...
    class UButton* Button_35;                                                         // 0x0370 (size: 0x8)
    class UImage* Image_76;                                                           // 0x0378 (size: 0x8)
    class UImage* Image_103;                                                          // 0x0380 (size: 0x8)
    class UImage* leftImg;                                                            // 0x0388 (size: 0x8)
    class UMD_NaviAutoHotkey_C* MD_NaviAutoHotkey;                                    // 0x0390 (size: 0x8)
    class UTextBlock* TextBlock;                                                      // 0x0398 (size: 0x8)
    FName TextKey;                                                                    // 0x03A0 (size: 0x8)
    FmenuButton_COnReleased OnReleased;                                               // 0x03A8 (size: 0x10)
    void onReleased();
    int32 FontSize;                                                                   // 0x03B8 (size: 0x4)
