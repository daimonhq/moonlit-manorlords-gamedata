...
class UfuelStocks_C : public UNaviSubGrid
{
    ...
    class UImage* fuel_img;                                                           // 0x0378 (size: 0x8)
    class UHorizontalBox* fuel_reserves_hb;                                           // 0x0380 (size: 0x8)
    class UTextBlock* fuelCount_txt;                                                  // 0x0388 (size: 0x8)
    class UW_LegacyButton_C* HelpButton;                                              // 0x0390 (size: 0x8)
    class UImage* Image_1;                                                            // 0x0398 (size: 0x8)
    class UImage* Image_10;                                                           // 0x03A0 (size: 0x8)
    ...
    void Construct();
    void BndEvt__fuelStocks_HelpButton_K2Node_ComponentBoundEvent_3_OnClicked__DelegateSignature(class UW_MaterialButton_C* MyWidget);
    void BndEvt__fuelStocks_HelpButton_K2Node_ComponentBoundEvent_4_OnInitToolTip__DelegateSignature(class UUserWidget* InToolTip, class UNaviUi* InSourceButton);
