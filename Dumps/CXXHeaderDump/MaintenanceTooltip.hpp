...
class UMaintenanceTooltip_C : public UUserWidget
{
    ...
    class UlocalizedTextBox_C* localizedTextBox_1;                                    // 0x0318 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox_2;                                    // 0x0320 (size: 0x8)
    class UTextBlock* MaintenanceStatus_txt;                                          // 0x0328 (size: 0x8)
    class UTextBlock* modifier_um_txt;                                                // 0x0330 (size: 0x8)
    class UVerticalBox* ModifierList_VB;                                              // 0x0338 (size: 0x8)
    class UTextBlock* name_txt_1;                                                     // 0x0340 (size: 0x8)
    class UTextBlock* pst_none_txt_1;                                                 // 0x0348 (size: 0x8)
    class UTextBlock* TextBlock_59;                                                   // 0x0350 (size: 0x8)
    FMaintenanceTypes MaintenanceTypes;                                               // 0x0358 (size: 0x10)
    class UMaintenanceComponent* Maintenance Component;                               // 0x0368 (size: 0x8)
