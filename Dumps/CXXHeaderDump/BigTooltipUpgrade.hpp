...
class UBigTooltipUpgrade_C : public UUserWidget
{
    ...
    FUpgrade UpgradeData;                                                             // 0x0388 (size: 0x138)
    FText requiredBranchesTranslatedTxt;                                              // 0x04C0 (size: 0x10)
    class ASMBuildingMaster* relevantBuilding;                                        // 0x04D0 (size: 0x8)
    int32 missingDevBranchesNum;                                                      // 0x04D8 (size: 0x4)
    TArray<FName> reasonWhyCantUpgrade;                                               // 0x04E0 (size: 0x10)
    int32 UpgradeCost_Wealth;                                                         // 0x04F0 (size: 0x4)
    ...
    void Construct();
    void UpdateWithBuilding(class ASMBuildingMaster* relevantBuilding, int32 ID, TArray<FName>& reasonWhyCantUpgrade);
