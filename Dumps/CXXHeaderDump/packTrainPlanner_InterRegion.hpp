...
class UpackTrainPlanner_InterRegion_C : public UNaviSubGrid
{
    ...
    class UTextBlock* barter_value_txt;                                               // 0x0370 (size: 0x8)
    class UTextBlock* barter_warning;                                                 // 0x0378 (size: 0x8)
    class UOverlay* BarterValueParent;                                                // 0x0380 (size: 0x8)
    class UComboBoxString* ComboBox_buying;                                           // 0x0388 (size: 0x8)
    class UComboBoxString* ComboBox_region;                                           // 0x0390 (size: 0x8)
    class UComboBoxString* ComboBox_selling;                                          // 0x0398 (size: 0x8)
    class UImage* Image;                                                              // 0x03A0 (size: 0x8)
    class UImage* Image_4;                                                            // 0x03A8 (size: 0x8)
    class UImage* Image_34;                                                           // 0x03B0 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox;                                      // 0x03B8 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox_1;                                    // 0x03C0 (size: 0x8)
    class UlocalizedTextBox_C* localizedTextBox_128;                                  // 0x03C8 (size: 0x8)
    class UMD_NaviComboBoxWrapper_C* navi_ComboBuying;                                // 0x03D0 (size: 0x8)
    class UMD_NaviComboBoxWrapper_C* navi_ComboSelling;                               // 0x03D8 (size: 0x8)
    class UMD_NaviComboBoxWrapper_C* navi_RegionId;                                   // 0x03E0 (size: 0x8)
    class UMD_NaviAutoTooltip_C* navi_ValueTooltip;                                   // 0x03E8 (size: 0x8)
    class UVerticalBox* transportlist_vb_1;                                           // 0x03F0 (size: 0x8)
    class ASMBuildingMaster* building;                                                // 0x03F8 (size: 0x8)
