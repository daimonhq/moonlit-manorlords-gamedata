...
class UsaveSlot_widget_C : public UUserWidget
{
    ...
    class UMD_NaviAutoButton_C* navi_renameBtn;                                       // 0x0308 (size: 0x8)
    class UTextBlock* non_editable_name;                                              // 0x0310 (size: 0x8)
    class UButton* rename_button;                                                     // 0x0318 (size: 0x8)
    class UImage* SavethumbDisplay;                                                   // 0x0320 (size: 0x8)
    class UsquareButton_C* squareButton_Delete;                                       // 0x0328 (size: 0x8)
    class UsquareButton_C* squareButton_SaveLoad;                                     // 0x0330 (size: 0x8)
    class UHorizontalBox* ver_hb;                                                     // 0x0338 (size: 0x8)
    class UVerticalBox* VerticalBox_48;                                               // 0x0340 (size: 0x8)
    class UTextBlock* verTxt_1;                                                       // 0x0348 (size: 0x8)
    bool saveMode;                                                                    // 0x0350 (size: 0x1)
    FString SlotName;                                                                 // 0x0358 (size: 0x10)
    bool newSave;                                                                     // 0x0368 (size: 0x1)
    class UTextureRenderTarget2D* thumb_RT;                                           // 0x0370 (size: 0x8)
    FString Level Name;                                                               // 0x0378 (size: 0x10)
    FsaveSlot_widget_COnConfirmDialogChange OnConfirmDialogChange;                    // 0x0388 (size: 0x10)
    void OnConfirmDialogChange(bool DialogOpened, class UNaviUi* Dialog);
    class UMLSaveGameDescr* SaveDescriptor;                                           // 0x0398 (size: 0x8)
    class UTexture2D* thumbnailTexture;                                               // 0x03A0 (size: 0x8)
    TSubclassOf<class UCoatOfArmsLibrary> CoatOfArmsLibraryClass;                     // 0x03A8 (size: 0x8)
    bool autoSave;                                                                    // 0x03B0 (size: 0x1)
    class Umenu_saveLoadMenu_C* SaveLoadMenu;                                         // 0x03B8 (size: 0x8)
    class UcreateNewSave_C* ActiveSaveSlot;                                           // 0x03C0 (size: 0x8)
