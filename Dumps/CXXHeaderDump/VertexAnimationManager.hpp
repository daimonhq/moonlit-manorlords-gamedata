...
{
    bool bWithSpatialSystem;                                                          // 0x0000 (size: 0x1)
    TEnumAsByte<ENotifyEventType> Type;                                               // 0x0001 (size: 0x1)
...
struct FVertexAnimation
{
    ...
    TArray<FVertexAnimationSection> Sections;                                         // 0x00A0 (size: 0x10)
...
struct FVertexAnimationSection
{
    FName Name;                                                                       // 0x0000 (size: 0x8)
    float TimeStart;                                                                  // 0x0008 (size: 0x4)
    float TimeEnd;                                                                    // 0x000C (size: 0x4)
    int32 FrameStart;                                                                 // 0x0010 (size: 0x4)
    int32 FrameEnd;                                                                   // 0x0014 (size: 0x4)
    float FrameSequenceLength;                                                        // 0x0018 (size: 0x4)
...
class UVARuntimeComponent : public UActorComponent
{
    ...
    FTimerHandle AnimationOnEndTimer;                                                 // 0x0298 (size: 0x8)
    FVARuntimeComponentOnAimOffset OnAimOffset;                                       // 0x02B0 (size: 0x10)
    void OnAimOffsetSignature();
    FVARuntimeComponentOnAnimationEnd OnAnimationEnd;                                 // 0x02C0 (size: 0x10)
    void OnAnimationEndSignature();
    class UVAWorldSubsystem* Subsystem;                                               // 0x02D0 (size: 0x8)
    class USkeletalMeshComponent* SkeletalMeshComponent;                              // 0x02D8 (size: 0x8)
    class UVertexAnimationProfile* Profile;                                           // 0x02E0 (size: 0x8)
    TSoftObjectPtr<UVertexAnimationProfile> ProfileAsset;                             // 0x02E8 (size: 0x28)
    TSoftObjectPtr<USkeletalMesh> SkeletalMesh;                                       // 0x0310 (size: 0x28)
    TSubclassOf<class USkeletalMeshComponent> SkeletalMeshComponentClass;             // 0x0338 (size: 0x8)
    TSubclassOf<class UAnimInstance> AnimClass;                                       // 0x0340 (size: 0x8)
    TSubclassOf<class UVANotifyHandler> NotifyHandlerClass;                           // 0x0348 (size: 0x8)
    bool bDebugBones;                                                                 // 0x0350 (size: 0x1)
    FVADebugBoneSettings BoneSettings;                                                // 0x0354 (size: 0xC)
    bool bPlaying;                                                                    // 0x0360 (size: 0x1)
    bool bFrameInterpolation;                                                         // 0x0361 (size: 0x1)
    bool bAnimationTransition;                                                        // 0x0362 (size: 0x1)
    float AnimationTransitionDuration;                                                // 0x0364 (size: 0x4)
    bool bNotifications;                                                              // 0x0368 (size: 0x1)
    bool bUseSyncGroup;                                                               // 0x0369 (size: 0x1)
    FName animationName;                                                              // 0x036C (size: 0x8)
    float AnimationPlayRate;                                                          // 0x0374 (size: 0x4)
    TEnumAsByte<EVARootMotionMode> RootMotionMode;                                    // 0x0378 (size: 0x1)
    bool bUpdateTransforms;                                                           // 0x0379 (size: 0x1)
    bool bSync;                                                                       // 0x037A (size: 0x1)
    float SyncFrameRate;                                                              // 0x037C (size: 0x4)
    bool bLODEnabled;                                                                 // 0x0380 (size: 0x1)
    FVertexAnimationLOD LOD;                                                          // 0x0384 (size: 0x30)
    bool bPhysics;                                                                    // 0x03B4 (size: 0x1)
    bool bComputeShader;                                                              // 0x03B5 (size: 0x1)
    int32 ComputeShaderMaxInstances;                                                  // 0x03B8 (size: 0x4)
    int32 ComputeShaderInstance;                                                      // 0x03BC (size: 0x4)
    class UVAInstancedComponent* InstancedComponent;                                  // 0x03C0 (size: 0x8)
    TArray<class UShapeComponent*> PhysicsShapes;                                     // 0x03C8 (size: 0x10)
    int32 NotifyCullDistance;                                                         // 0x03D8 (size: 0x4)
    float NearDistanceSqr;                                                            // 0x03E0 (size: 0x4)
    float MidDistanceSqr;                                                             // 0x03E4 (size: 0x4)
    float FarDistanceSqr;                                                             // 0x03E8 (size: 0x4)
    bool bEnableDistanceBasedUpdates;                                                 // 0x03EC (size: 0x1)
    ...
    void Reset();
    void Reregister();
    bool PlaySection(FName animationName, int32 SectionIndex, bool Loop);
    ...
    float GetPosition();
    float GetPlayRateScaled(float Value);
    float GetPlayRate();
...
{
    TMap<class FGuid, class UVAInstancedManager*> InstancedManager;                   // 0x0078 (size: 0x50)
    TArray<class UVARuntimeComponent*> SyncComponents;                                // 0x00C8 (size: 0x10)
    TMap<class FGuid, class UVAInstancedComponent*> InstancedComponent;               // 0x0180 (size: 0x50)
